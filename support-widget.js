...
/* T-MAP • Support Widget (hide URL + spacing)
   - Hides URL line in UI, keeps page_url in DB
   - Adds vertical spacing between the Google sign-in box and the Send button
   - Redirect fix: redirectTo = location.href
   - Modal show/hide fix
*/
...
const css = `
  ...
  /* children inside v-new */
  #v-new > * + * { margin-top: 8px; }           /* ~2mm spacing between blocks */
  .row{display:grid;gap:6px}                    /* inputs inside a block */
