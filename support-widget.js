...
/* T-MAP Support Widget (ESM) — adds a floating "Ask admin" pop-up without touching the page markup.
   Usage: <script type="module" src="support-widget.js"></script>
*/
...
const CONFIG = {
  ...
  ADMIN_EMAIL: "82angeluzunov@gmail.com",
};
...
// Host + Shadow DOM (to avoid CSS collisions)
    ...
    <div class="bd">
      ...
      <div id="v-new">
        ...
        <div class="row"><label>Въпрос</label>
          ...
          <div class="muted">URL: <span id="pg">${location.href}</span></div>
        </div>
...
async function signInGoogle(){
  const { data, error } = await supabase.auth.signInWithOAuth({
    provider: "google",
    options: { skipBrowserRedirect: true, redirectTo: location.origin }
  });
